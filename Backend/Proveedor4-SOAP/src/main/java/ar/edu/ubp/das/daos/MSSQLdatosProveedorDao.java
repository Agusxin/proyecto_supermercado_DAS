...
public class MSSQLdatosProveedorDao extends Dao<String, String, String>{
	...
	public String make(ResultSet result) throws SQLException {
		return result.getString("informacion_proveedor");
	}

	@Override
	public List<String> select(String arg0) throws SQLException {
		this.connect();
		this.setProcedure("enviar_informacion_del_proveedor");

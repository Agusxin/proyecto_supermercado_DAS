...
@XmlRootElement(name = "getPedidosInfo", namespace = "http://ws.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getPedidosInfo", namespace = "http://ws.das.ubp.edu.ar/", propOrder = {"arg0", "arg1"})

public class GetPedidosInfo {
